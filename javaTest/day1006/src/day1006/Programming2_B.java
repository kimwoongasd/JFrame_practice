...
public class Programming2_B {
	...
	public static void main(String[] args) {
		...
		// 대소문자 구분 없이 같은지 확인: equalsIgnoreCase
		// equalsIgnoreCase은 switch를 사용할 수 없다
		if (!op.equalsIgnoreCase("R") && !op.equalsIgnoreCase("T") && !op.equalsIgnoreCase("C")) {
